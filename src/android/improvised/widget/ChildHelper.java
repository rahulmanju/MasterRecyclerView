...
class ChildHelper {
     ...
     * @param type     View type, can be {@link MasterRecyclerView#INVALID_TYPE}.
    ...
    View findHiddenNonRemovedView(int position, int type) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            MasterRecyclerView.ViewHolder holder = mCallback.getChildViewHolder(view);
            if (holder.getLayoutPosition() == position && !holder.isInvalid() && !holder.isRemoved()
                    && (type == MasterRecyclerView.INVALID_TYPE || holder.getItemViewType() == type)) {
                return view;
            }
        }
        return null;
    ...
    static interface Callback {
        ...
        MasterRecyclerView.ViewHolder getChildViewHolder(View view);
