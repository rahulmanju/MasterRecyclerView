...
/**
 * {@link MasterRecyclerView.SmoothScroller} implementation which uses
 ...
 */
abstract public class LinearSmoothScroller extends MasterRecyclerView.SmoothScroller {
     ...
     */
    @Override
    protected void onTargetFound(View targetView, MasterRecyclerView.State state, Action action) {
     ...
     */
    @Override
    protected void onSeekTargetStep(int dx, int dy, MasterRecyclerView.State state, Action action) {
        if (getChildCount() == 0) {
            stop();
            return;
        }
    ...
    public int calculateDyToMakeVisible(View view, int snapPreference) {
        final MasterRecyclerView.LayoutManager layoutManager = getLayoutManager();
