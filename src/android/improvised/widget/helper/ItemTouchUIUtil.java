 ...
 * {@link MasterRecyclerView.ViewHolder#itemView} and {@link ItemTouchUIUtil} makes necessary changes
...
public interface ItemTouchUIUtil {
     ...
     * MasterRecyclerView, MasterRecyclerView.ViewHolder, float, float, int, boolean)}
     */
    void onDraw(Canvas c, MasterRecyclerView masterRecyclerView, View view,
     ...
     * MasterRecyclerView, MasterRecyclerView.ViewHolder, float, float, int, boolean)}
     */
    void onDrawOver(Canvas c, MasterRecyclerView masterRecyclerView, View view,
                    float dX, float dY, int actionState, boolean isCurrentlyActive);

    /**
     * The default implementation for {@link ItemTouchHelper.Callback#clearView(MasterRecyclerView,
     * MasterRecyclerView.ViewHolder)}
     */
    void clearView(View view);

    /**
     * The default implementation for {@link ItemTouchHelper.Callback#onSelectedChanged(
     * MasterRecyclerView.ViewHolder, int)}
     */
