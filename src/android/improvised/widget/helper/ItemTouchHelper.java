...
package android.improvised.widget.helper;
...
import android.improvised.widget.MasterRecyclerView.OnItemTouchListener;
import android.improvised.widget.MasterRecyclerView.ViewHolder;
 ...
 * {@link Callback#onMove(MasterRecyclerView, ViewHolder, ViewHolder)} and / or
 ...
 * overriding {@link Callback#onChildDraw(Canvas, MasterRecyclerView, ViewHolder, float, float, int,
 * boolean)}
 * or {@link Callback#onChildDrawOver(Canvas, MasterRecyclerView, ViewHolder, float, float, int,
 * boolean)}.
 * <p/>
 ...
 */
public class ItemTouchHelper extends MasterRecyclerView.ItemDecoration
        implements MasterRecyclerView.OnChildAttachStateChangeListener {
     ...
     * {@link Callback#getAbsoluteMovementFlags(MasterRecyclerView, ViewHolder)} for the current
     * action state.
     */
    int mSelectedFlags;
    ...
    private final Runnable mScrollRunnable = new Runnable() {
        ...
        public void run() {
            if (mSelected != null && scrollIfNecessary()) {
                ...
                mMasterRecyclerView.removeCallbacks(mScrollRunnable);
                ViewCompat.postOnAnimation(mMasterRecyclerView, this);
            }
        }
    };
     ...
     */
    private MasterRecyclerView.ChildDrawingOrderCallback mChildDrawingOrderCallback = null;
    ...
    private final OnItemTouchListener mOnItemTouchListener
        ...
        @Override
        public boolean onInterceptTouchEvent(MasterRecyclerView masterRecyclerView, MotionEvent event) {
                ...
                if (mSelected == null) {
                    ...
                    if (animation != null) {
                        ...
                        if (mPendingCleanup.remove(animation.mViewHolder.itemView)) {
                            mCallback.clearView(mMasterRecyclerView, animation.mViewHolder);
                        }
        ...
        @Override
        public void onTouchEvent(MasterRecyclerView masterRecyclerView, MotionEvent event) {
            mGestureDetector.onTouchEvent(event);
            if (DEBUG) {
                Log.d(TAG,
     ...
     * {@link #attachToRecyclerView(MasterRecyclerView)}. Upon attaching, it will add an item decoration,
     ...
     *
     * @param masterRecyclerView The RecyclerView instance to which you want to add this helper or
     *                     {@code null} if you want to remove ItemTouchHelper from the current
     *                     RecyclerView.
     */
    public void attachToRecyclerView(@Nullable MasterRecyclerView masterRecyclerView) {
        if (mMasterRecyclerView == masterRecyclerView) {
        ...
        if (mMasterRecyclerView != null) {
            final Resources resources = masterRecyclerView.getResources();
    ...
    private void setupCallbacks() {
        ViewConfiguration vc = ViewConfiguration.get(mMasterRecyclerView.getContext());
        mSlop = vc.getScaledTouchSlop();
        mMasterRecyclerView.addItemDecoration(this);
        mMasterRecyclerView.addOnItemTouchListener(mOnItemTouchListener);
        mMasterRecyclerView.addOnChildAttachStateChangeListener(this);
        initGestureDetector();
    }

    private void destroyCallbacks() {
        mMasterRecyclerView.removeItemDecoration(this);
        mMasterRecyclerView.removeOnItemTouchListener(mOnItemTouchListener);
        mMasterRecyclerView.removeOnChildAttachStateChangeListener(this);
        // clean all attached
        final int recoverAnimSize = mRecoverAnimations.size();
        for (int i = recoverAnimSize - 1; i >= 0; i--) {
            final RecoverAnimation recoverAnimation = mRecoverAnimations.get(0);
            mCallback.clearView(mMasterRecyclerView, recoverAnimation.mViewHolder);
        }
    ...
    private void initGestureDetector() {
        ...
        mGestureDetector = new GestureDetectorCompat(mMasterRecyclerView.getContext(),
    ...
    @Override
    public void onDrawOver(Canvas c, MasterRecyclerView parent, MasterRecyclerView.State state) {
        float dx = 0, dy = 0;
        if (mSelected != null) {
    ...
    @Override
    public void onDraw(Canvas c, MasterRecyclerView parent, MasterRecyclerView.State state) {
    ...
    private void select(ViewHolder selected, int actionState) {
        ...
        if (mSelected != null) {
            ...
            if (prevSelected.itemView.getParent() != null) {
                ...
                switch (swipeDir) {
                    ...
                    case END:
                        targetTranslateY = 0;
                        targetTranslateX = Math.signum(mDx) * mMasterRecyclerView.getWidth();
                        break;
                    case UP:
                    case DOWN:
                        targetTranslateX = 0;
                        targetTranslateY = Math.signum(mDy) * mMasterRecyclerView.getHeight();
                        break;
                    default:
                        targetTranslateX = 0;
                        targetTranslateY = 0;
                ...
                final RecoverAnimation rv = new RecoverAnimation(prevSelected, animationType,
                    ...
                    public void onAnimationEnd(ValueAnimatorCompat animation) {
                        ...
                        if (swipeDir <= 0) {
                            ...
                            mCallback.clearView(mMasterRecyclerView, prevSelected);
                ...
                final long duration = mCallback.getAnimationDuration(mMasterRecyclerView, animationType,
        ...
        if (selected != null) {
            mSelectedFlags =
                    (mCallback.getAbsoluteMovementFlags(mMasterRecyclerView, selected) & actionStateMask)
        ...
        final ViewParent rvParent = mMasterRecyclerView.getParent();
        if (rvParent != null) {
            rvParent.requestDisallowInterceptTouchEvent(mSelected != null);
        }
        if (!preventLayout) {
            mMasterRecyclerView.getLayoutManager().requestSimpleAnimationsInNextLayout();
        }
    ...
    private void postDispatchSwipe(final RecoverAnimation anim, final int swipeDir) {
        ...
        mMasterRecyclerView.post(new Runnable() {
            @Override
            public void run() {
                if (mMasterRecyclerView != null && mMasterRecyclerView.isAttachedToWindow() &&
                        !anim.mOverridden &&
                        anim.mViewHolder.getAdapterPosition() != MasterRecyclerView.NO_POSITION) {
                    final MasterRecyclerView.ItemAnimator animator = mMasterRecyclerView.getItemAnimator();
    ...
    private boolean scrollIfNecessary() {
        ...
        MasterRecyclerView.LayoutManager lm = mMasterRecyclerView.getLayoutManager();
        if (mTmpRect == null) {
            mTmpRect = new Rect();
        }
        int scrollX = 0;
        ...
        if (lm.canScrollHorizontally()) {
            ...
            final int leftDiff = curX - mTmpRect.left - mMasterRecyclerView.getPaddingLeft();
            if (mDx < 0 && leftDiff < 0) {
                scrollX = leftDiff;
            } else if (mDx > 0) {
                final int rightDiff =
                        curX + mSelected.itemView.getWidth() + mTmpRect.right
                                - (mMasterRecyclerView.getWidth() - mMasterRecyclerView.getPaddingRight());
                if (rightDiff > 0) {
                    scrollX = rightDiff;
                }
            }
        ...
        if (lm.canScrollVertically()) {
            ...
            final int topDiff = curY - mTmpRect.top - mMasterRecyclerView.getPaddingTop();
            if (mDy < 0 && topDiff < 0) {
                scrollY = topDiff;
            } else if (mDy > 0) {
                final int bottomDiff = curY + mSelected.itemView.getHeight() + mTmpRect.bottom -
                        (mMasterRecyclerView.getHeight() - mMasterRecyclerView.getPaddingBottom());
                if (bottomDiff > 0) {
                    scrollY = bottomDiff;
                }
            }
        ...
        if (scrollX != 0) {
            scrollX = mCallback.interpolateOutOfBoundsScroll(mMasterRecyclerView,
                    mSelected.itemView.getWidth(), scrollX,
                    mMasterRecyclerView.getWidth(), scrollDuration);
        }
        if (scrollY != 0) {
            scrollY = mCallback.interpolateOutOfBoundsScroll(mMasterRecyclerView,
                    mSelected.itemView.getHeight(), scrollY,
                    mMasterRecyclerView.getHeight(), scrollDuration);
        }
        if (scrollX != 0 || scrollY != 0) {
            if (mDragScrollStartTimeInMs == Long.MIN_VALUE) {
                mDragScrollStartTimeInMs = now;
            }
            mMasterRecyclerView.scrollBy(scrollX, scrollY);
            return true;
        }
        mDragScrollStartTimeInMs = Long.MIN_VALUE;
        return false;
    ...
    private List<ViewHolder> findSwapTargets(ViewHolder viewHolder) {
        ...
        final MasterRecyclerView.LayoutManager lm = mMasterRecyclerView.getLayoutManager();
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            final ViewHolder otherVh = mMasterRecyclerView.getChildViewHolder(other);
            if (mCallback.canDropOver(mMasterRecyclerView, mSelected, otherVh)) {
    ...
    private void moveIfNecessary(ViewHolder viewHolder) {
        if (mMasterRecyclerView.isLayoutRequested()) {
            return;
        }
        ...
        if (mCallback.onMove(mMasterRecyclerView, viewHolder, target)) {
            // keep target visible
            mCallback.onMoved(mMasterRecyclerView, viewHolder, fromPosition,
    ...
    public void onChildViewDetachedFromWindow(View view) {
        ...
        final ViewHolder holder = mMasterRecyclerView.getChildViewHolder(view);
        if (holder == null) {
            return;
        }
        if (mSelected != null && holder == mSelected) {
            ...
            if (mPendingCleanup.remove(holder.itemView)) {
                mCallback.clearView(mMasterRecyclerView, holder);
            }
        }
    }
    ...
    @Override
    public void getItemOffsets(Rect outRect, View view, MasterRecyclerView parent,
                               MasterRecyclerView.State state) {
        outRect.setEmpty();
    }
    ...
    private ViewHolder findSwipedView(MotionEvent motionEvent) {
        ...
        return mMasterRecyclerView.getChildViewHolder(child);
    }
    ...
    private boolean checkSelectForSwipe(int action, MotionEvent motionEvent, int pointerIndex) {
        ...
        if (mMasterRecyclerView.getScrollState() == MasterRecyclerView.SCROLL_STATE_DRAGGING) {
            return false;
        }
        ...
        final int movementFlags = mCallback.getAbsoluteMovementFlags(mMasterRecyclerView, vh);
    ...
    private View findChildView(MotionEvent event) {
        ...
        return mMasterRecyclerView.findChildViewUnder(x, y);
    }
    ...
    public void startDrag(ViewHolder viewHolder) {
        if (!mCallback.hasDragFlag(mMasterRecyclerView, viewHolder)) {
            Log.e(TAG, "Start drag has been called but swiping is not enabled");
            return;
        }
        if (viewHolder.itemView.getParent() != mMasterRecyclerView) {
    ...
    public void startSwipe(ViewHolder viewHolder) {
        if (!mCallback.hasSwipeFlag(mMasterRecyclerView, viewHolder)) {
    ...
    private int swipeIfNecessary(ViewHolder viewHolder) {
        ...
        final int originalMovementFlags = mCallback.getMovementFlags(mMasterRecyclerView, viewHolder);
        final int absoluteMovementFlags = mCallback.convertToAbsoluteDirection(
                originalMovementFlags,
                ViewCompat.getLayoutDirection(mMasterRecyclerView));
    ...
    private int checkHorizontalSwipe(ViewHolder viewHolder, int flags) {
        if ((flags & (LEFT | RIGHT)) != 0) {
            ...
            final float threshold = mMasterRecyclerView.getWidth() * mCallback
    ...
    private int checkVerticalSwipe(ViewHolder viewHolder, int flags) {
        if ((flags & (UP | DOWN)) != 0) {
            ...
            final float threshold = mMasterRecyclerView.getHeight() * mCallback
                    .getSwipeThreshold(viewHolder);
    ...
    private void addChildDrawingOrderCallback() {
        ...
        if (mChildDrawingOrderCallback == null) {
            mChildDrawingOrderCallback = new MasterRecyclerView.ChildDrawingOrderCallback() {
                @Override
                public int onGetChildDrawingOrder(int childCount, int i) {
                    ...
                    if (childPosition == -1) {
                        childPosition = mMasterRecyclerView.indexOfChild(mOverdrawChild);
        ...
        mMasterRecyclerView.setChildDrawingOrderCallback(mChildDrawingOrderCallback);
    }
    ...
    private void removeChildDrawingOrderCallbackIfNecessary(View view) {
        if (view == mOverdrawChild) {
            ...
            if (mChildDrawingOrderCallback != null) {
                mMasterRecyclerView.setChildDrawingOrderCallback(null);
            }
        }
    }
     ...
     * {@link #getMovementFlags(MasterRecyclerView, ViewHolder)} and return appropriate set
     ...
     * {@link Callback#onMove(MasterRecyclerView, ViewHolder, ViewHolder)
     ...
     * in your adapter and also call {@link MasterRecyclerView.Adapter#notifyItemMoved(int, int)}.
     * To control where a View can be dropped, you can override
     * {@link #canDropOver(MasterRecyclerView, ViewHolder, ViewHolder)}. When a
    ...
    public abstract static class Callback {
         ...
         * {@link MasterRecyclerView.ViewHolder#itemView}.
         * <p>
         ...
         * swiping.
         *
         * @param masterRecyclerView The RecyclerView to which ItemTouchHelper is attached.
         * @param viewHolder   The ViewHolder for which the movement information is necessary.
         * @return flags specifying which movements are allowed on this ViewHolder.
         * @see #makeMovementFlags(int, int)
         * @see #makeFlag(int, int)
         */
        public abstract int getMovementFlags(MasterRecyclerView masterRecyclerView,
        ...
        final int getAbsoluteMovementFlags(MasterRecyclerView masterRecyclerView,
                                           ViewHolder viewHolder) {
            final int flags = getMovementFlags(masterRecyclerView, viewHolder);
            return convertToAbsoluteDirection(flags, ViewCompat.getLayoutDirection(masterRecyclerView));
        }

        private boolean hasDragFlag(MasterRecyclerView masterRecyclerView, ViewHolder viewHolder) {
            final int flags = getAbsoluteMovementFlags(masterRecyclerView, viewHolder);
            return (flags & ACTION_MODE_DRAG_MASK) != 0;
        }

        private boolean hasSwipeFlag(MasterRecyclerView masterRecyclerView,
                                     ViewHolder viewHolder) {
            final int flags = getAbsoluteMovementFlags(masterRecyclerView, viewHolder);
         ...
         *
         * @param masterRecyclerView The RecyclerView to which ItemTouchHelper is attached to.
         ...
         * otherwise.
         */
        public boolean canDropOver(MasterRecyclerView masterRecyclerView, ViewHolder current,
                                   ViewHolder target) {
            return true;
        }
         ...
         * {@code target}.
         * @see #onMoved(MasterRecyclerView, ViewHolder, int, ViewHolder, int, int, int)
         */
        public abstract boolean onMove(MasterRecyclerView masterRecyclerView,
         ...
         *                    {@link MasterRecyclerView.ItemDecoration}s.
         ...
         * {@link #getMovementFlags(MasterRecyclerView, ViewHolder)} method, this method
         ...
         * {@link #clearView(MasterRecyclerView, ViewHolder)}.
         *
         * @param viewHolder The ViewHolder which has been swiped by the user.
         * @param direction  The direction to which the ViewHolder is swiped. It is one of
         *                   {@link #UP}, {@link #DOWN},
         *                   {@link #LEFT} or {@link #RIGHT}. If your
         *                   {@link #getMovementFlags(MasterRecyclerView, ViewHolder)}
         *                   method
         ...
         * @see #clearView(MasterRecyclerView, MasterRecyclerView.ViewHolder)
         */
        ...
        private int getMaxDragScroll(MasterRecyclerView masterRecyclerView) {
            if (mCachedMaxScrollSpeed == -1) {
                mCachedMaxScrollSpeed = masterRecyclerView.getResources().getDimensionPixelSize(
        ...
        /**
         * Called when {@link #onMove(MasterRecyclerView, ViewHolder, ViewHolder)} returns true.
         * <p>
         ...
         *
         * Default implementation calls {@link MasterRecyclerView#scrollToPosition(int)} if the View's
         ...
         *
         * @param masterRecyclerView The RecyclerView controlled by the ItemTouchHelper.
         ...
         *                     {@link MasterRecyclerView.ItemDecoration}s.
         */
        public void onMoved(final MasterRecyclerView masterRecyclerView,
                final ViewHolder viewHolder, int fromPos, final ViewHolder target, int toPos, int x,
                int y) {
            final MasterRecyclerView.LayoutManager layoutManager = masterRecyclerView.getLayoutManager();
            ...
            if (layoutManager.canScrollHorizontally()) {
                ...
                if (minLeft <= masterRecyclerView.getPaddingLeft()) {
                    masterRecyclerView.scrollToPosition(toPos);
                }
                final int maxRight = layoutManager.getDecoratedRight(target.itemView);
                if (maxRight >= masterRecyclerView.getWidth() - masterRecyclerView.getPaddingRight()) {
                    masterRecyclerView.scrollToPosition(toPos);
                }
            }
            ...
            if (layoutManager.canScrollVertically()) {
                ...
                if (minTop <= masterRecyclerView.getPaddingTop()) {
                    masterRecyclerView.scrollToPosition(toPos);
                }
                final int maxBottom = layoutManager.getDecoratedBottom(target.itemView);
                if (maxBottom >= masterRecyclerView.getHeight() - masterRecyclerView.getPaddingBottom()) {
                    masterRecyclerView.scrollToPosition(toPos);
                }
            }
        }

        private void onDraw(Canvas c, MasterRecyclerView parent, ViewHolder selected,
        ...
        private void onDrawOver(Canvas c, MasterRecyclerView parent, ViewHolder selected,
                                List<ItemTouchHelper.RecoverAnimation> recoverAnimationList,
                                int actionState, float dX, float dY) {
            final int recoverAnimSize = recoverAnimationList.size();
            for (int i = 0; i < recoverAnimSize; i++) {
         ...
         * {@link #onSelectedChanged(MasterRecyclerView.ViewHolder, int)},
         * {@link #onChildDraw(Canvas, MasterRecyclerView, ViewHolder, float, float, int,
         * boolean)} or
         * {@link #onChildDrawOver(Canvas, MasterRecyclerView, ViewHolder, float, float, int, boolean)}.
         *
         * @param masterRecyclerView The RecyclerView which is controlled by the ItemTouchHelper.
         * @param viewHolder   The View that was interacted by the user.
         */
        public void clearView(MasterRecyclerView masterRecyclerView, ViewHolder viewHolder) {
         ...
         * @see #onChildDrawOver(Canvas, MasterRecyclerView, ViewHolder, float, float, int,
         * boolean)
         */
        public void onChildDraw(Canvas c, MasterRecyclerView masterRecyclerView,
                                ViewHolder viewHolder,
                                float dX, float dY, int actionState, boolean isCurrentlyActive) {
            sUICallback.onDraw(c, masterRecyclerView, viewHolder.itemView, dX, dY, actionState,
                    isCurrentlyActive);
        }
         ...
         * boolean)
         */
        public void onChildDrawOver(Canvas c, MasterRecyclerView masterRecyclerView,
                                    ViewHolder viewHolder,
                                    float dX, float dY, int actionState, boolean isCurrentlyActive) {
            sUICallback.onDrawOver(c, masterRecyclerView, viewHolder.itemView, dX, dY, actionState,
                    isCurrentlyActive);
        }
         ...
         * {@link MasterRecyclerView.ItemAnimator#getMoveDuration()}, otherwise, it returns
         * {@link MasterRecyclerView.ItemAnimator#getRemoveDuration()}. If RecyclerView does not have
         * any {@link MasterRecyclerView.ItemAnimator} attached, this method returns
         * {@code DEFAULT_DRAG_ANIMATION_DURATION} or {@code DEFAULT_SWIPE_ANIMATION_DURATION}
         * depending on the animation type.
         *
         * @param masterRecyclerView  The RecyclerView to which the ItemTouchHelper is attached to.
         ...
         */
        public long getAnimationDuration(MasterRecyclerView masterRecyclerView, int animationType,
                                         float animateDx, float animateDy) {
            final MasterRecyclerView.ItemAnimator itemAnimator = masterRecyclerView.getItemAnimator();
         ...
         *
         * @param masterRecyclerView        The RecyclerView instance to which ItemTouchHelper is
         *                            attached to.
         ...
         * be passed to {@link MasterRecyclerView#scrollBy(int, int)} method.
         */
        public int interpolateOutOfBoundsScroll(MasterRecyclerView masterRecyclerView,
                                                int viewSize, int viewSizeOutOfBounds,
                                                int totalSize, long msSinceStartScroll) {
            final int maxScroll = getMaxDragScroll(masterRecyclerView);
    ...
    public abstract static class SimpleCallback extends Callback {
         ...
         * {@link #getSwipeDirs(MasterRecyclerView, ViewHolder)}
         * and / or {@link #getDragDirs(MasterRecyclerView, ViewHolder)}.
         *
         ...
         */
        public int getSwipeDirs(MasterRecyclerView masterRecyclerView, ViewHolder viewHolder) {
         ...
         * @return A binary OR of direction flags.
         */
        public int getDragDirs(MasterRecyclerView masterRecyclerView, ViewHolder viewHolder) {
            return mDefaultDragDirs;
        }

        @Override
        public int getMovementFlags(MasterRecyclerView masterRecyclerView, ViewHolder viewHolder) {
            return makeMovementFlags(getDragDirs(masterRecyclerView, viewHolder),
                    getSwipeDirs(masterRecyclerView, viewHolder));
        }
    }
    ...
    private class ItemTouchHelperGestureListener extends GestureDetector.SimpleOnGestureListener {
        ...
        public void onLongPress(MotionEvent e) {
            ...
            if (child != null) {
                ViewHolder vh = mMasterRecyclerView.getChildViewHolder(child);
                if (vh != null) {
                    if (!mCallback.hasDragFlag(mMasterRecyclerView, vh)) {
                        return;
                    }
