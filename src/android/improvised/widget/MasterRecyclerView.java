...
import android.improvised.masterrecyclerview.R;
...
import android.improvised.widget.MasterRecyclerView.ItemAnimator.ItemHolderInfo;
...
import static android.improvised.widget.AdapterHelper.Callback;
import static android.improvised.widget.AdapterHelper.UpdateOp;
 ...
 */
public class MasterRecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    public MasterRecyclerView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MasterRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            int defStyleRes = 0;
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.MasterRecyclerView,
                    defStyle, defStyleRes);
            String layoutManagerName = a.getString(R.styleable.MasterRecyclerView_layoutManager);
            int descendantFocusability = a.getInt(
                    R.styleable.MasterRecyclerView_android_descendantFocusability, -1);
    ...
    private String getFullClassName(Context context, String className) {
        ...
        return MasterRecyclerView.class.getPackage().getName() + '.' + className;
    }
    ...
    private void initChildrenHelper() {
        mChildHelper = new ChildHelper(new ChildHelper.Callback() {
            ...
            public void addView(View child, int index) {
                MasterRecyclerView.this.addView(child, index);
            ...
            public void removeViewAt(int index) {
                final View child = MasterRecyclerView.this.getChildAt(index);
                if (child != null) {
                    dispatchChildDetached(child);
                }
                MasterRecyclerView.this.removeViewAt(index);
            }

            @Override
            public View getChildAt(int offset) {
                return MasterRecyclerView.this.getChildAt(offset);
            }
            ...
            public void attachViewToParent(View child, int index,
                ...
                MasterRecyclerView.this.attachViewToParent(child, index, layoutParams);
            }
            ...
            public void detachViewFromParent(int offset) {
                ...
                MasterRecyclerView.this.detachViewFromParent(offset);
            }
    ...
    void initAdapterManager() {
        mAdapterHelper = new AdapterHelper(new Callback() {
            ...
            void dispatchUpdate(UpdateOp op) {
                switch (op.cmd) {
                    case UpdateOp.ADD:
                        mLayout.onItemsAdded(MasterRecyclerView.this, op.positionStart, op.itemCount);
                        break;
                    case UpdateOp.REMOVE:
                        mLayout.onItemsRemoved(MasterRecyclerView.this, op.positionStart, op.itemCount);
                        break;
                    case UpdateOp.UPDATE:
                        mLayout.onItemsUpdated(MasterRecyclerView.this, op.positionStart, op.itemCount,
                                op.payload);
                        break;
                    case UpdateOp.MOVE:
                        mLayout.onItemsMoved(MasterRecyclerView.this, op.positionStart, op.itemCount, 1);
                        break;
                }
            }
    ...
    public void setLayoutManager(LayoutManager layout) {
        ...
        mLayout = layout;
        if (layout != null) {
            if (layout.mMasterRecyclerView != null) {
                throw new IllegalArgumentException("LayoutManager " + layout +
                        " is already attached to a RecyclerView: " + layout.mMasterRecyclerView);
            }
     ...
     * @see #addAnimatingView(MasterRecyclerView.ViewHolder)
     ...
     * {@link MasterRecyclerView.LayoutManager#scrollToPosition(int)}
     * @param position Scroll to this adapter position
     * @see MasterRecyclerView.LayoutManager#scrollToPosition(int)
     */
     ...
     * {@link LayoutManager#smoothScrollToPosition(MasterRecyclerView, State, int)} and create a
     * {@link SmoothScroller}.
     * <p>
     * {@link LayoutManager} is responsible for creating the actual scroll action. If you want to
     * provide a custom smooth scroll logic, override
     * {@link LayoutManager#smoothScrollToPosition(MasterRecyclerView, State, int)} in your
     * LayoutManager.
     *
     * @param position The adapter position to scroll to
     * @see LayoutManager#smoothScrollToPosition(MasterRecyclerView, State, int)
     */
     ...
     * {@link MasterRecyclerView.LayoutManager#computeHorizontalScrollOffset(MasterRecyclerView.State)} in your
     * LayoutManager. </p>
     *
     * @return The horizontal offset of the scrollbar's thumb
     * @see MasterRecyclerView.LayoutManager#computeHorizontalScrollOffset
     * (RecyclerView.State)
     */
    @Override
     ...
     *
     * <p>If you want to support scroll bars, override
     * {@link MasterRecyclerView.LayoutManager#computeHorizontalScrollExtent(MasterRecyclerView.State)} in your
     * LayoutManager.</p>
     *
     * @return The horizontal extent of the scrollbar's thumb
     * @see MasterRecyclerView.LayoutManager#computeHorizontalScrollExtent(MasterRecyclerView.State)
     */
    @Override
     ...
     *
     * <p>If you want to support scroll bars, override
     * {@link MasterRecyclerView.LayoutManager#computeHorizontalScrollRange(MasterRecyclerView.State)} in your
     * LayoutManager.</p>
     *
     * @return The total horizontal range represented by the vertical scrollbar
     * @see MasterRecyclerView.LayoutManager#computeHorizontalScrollRange(MasterRecyclerView.State)
     */
    @Override
     ...
     *
     * <p>If you want to support scroll bars, override
     * {@link MasterRecyclerView.LayoutManager#computeVerticalScrollOffset(MasterRecyclerView.State)} in your
     * LayoutManager.</p>
     *
     * @return The vertical offset of the scrollbar's thumb
     * @see MasterRecyclerView.LayoutManager#computeVerticalScrollOffset
     * (RecyclerView.State)
     */
    @Override
     ...
     *
     * <p>If you want to support scroll bars, override
     * {@link MasterRecyclerView.LayoutManager#computeVerticalScrollExtent(MasterRecyclerView.State)} in your
     * LayoutManager.</p>
     *
     * @return The vertical extent of the scrollbar's thumb
     * @see MasterRecyclerView.LayoutManager#computeVerticalScrollExtent(MasterRecyclerView.State)
     */
    @Override
     ...
     *
     * <p>If you want to support scroll bars, override
     * {@link MasterRecyclerView.LayoutManager#computeVerticalScrollRange(MasterRecyclerView.State)} in your
     * LayoutManager.</p>
     *
     * @return The total vertical range represented by the vertical scrollbar
     * @see MasterRecyclerView.LayoutManager#computeVerticalScrollRange(MasterRecyclerView.State)
     */
    @Override
     ...
     * returns true from
     * {@link OnItemTouchListener#onInterceptTouchEvent(MasterRecyclerView, MotionEvent)} its
     * {@link OnItemTouchListener#onTouchEvent(MasterRecyclerView, MotionEvent)} method will be called
    ...
    private class ViewFlinger implements Runnable {
        ...
        public void run() {
            ...
            if (scroller.computeScrollOffset()) {
                ...
                if (ViewCompat.getOverScrollMode(MasterRecyclerView.this) !=
    ...
    private class RecyclerViewDataObserver extends AdapterDataObserver {
        ...
        void triggerUpdateProcessor() {
            if (mPostUpdatesOnAnimation && mHasFixedSize && mIsAttached) {
                ViewCompat.postOnAnimation(MasterRecyclerView.this, mUpdateChildViewsRunnable);
            } else {
     ...
     * and use {@link MasterRecyclerView#setRecycledViewPool(RecycledViewPool)}.
     * <p>
    ...
    public final class Recycler {
         ...
         * {@link Adapter#onCreateViewHolder(ViewGroup, int,int)}.
         * <p>
        ...
        public void bindViewToPosition(View view, int position) {
            ...
            holder.mOwnerMasterRecyclerView = MasterRecyclerView.this;
        ...
        View getViewForPosition(int position, boolean dryRun) {
            ...
            if (holder == null) {
                ...
                if (holder == null) {
                    holder = mAdapter.createViewHolder(MasterRecyclerView.this, type,offsetPosition);
                    if (DEBUG) {
        ...
        void recycleViewHolderInternal(ViewHolder holder) {
            ...
            if (!cached && !recycled && transientStatePreventsRecycling) {
                holder.mOwnerMasterRecyclerView = null;
            }
        }
        ...
        ViewHolder getScrapViewForPosition(int position, int type, boolean dryRun) {
            ...
            if (!dryRun) {
                ...
                if (view != null) {
                    ...
                    if (layoutIndex == MasterRecyclerView.NO_POSITION) {
     ...
     * within a {@link MasterRecyclerView}.</p>
     */
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        /**
         * This method calls {@link #onCreateViewHolder(ViewGroup, int,int)} to create a new
         * {@link ViewHolder} and initializes some private fields to be used by RecyclerView.
         *
         * @see #onCreateViewHolder(ViewGroup, int,int)
         */
        public final VH createViewHolder(ViewGroup parent, int viewType,int position) {
            TraceCompat.beginSection(TRACE_CREATE_VIEW_TAG);
            final VH holder = onCreateViewHolder(parent, viewType,position);
         ...
         * needs to be attached to its parent {@link MasterRecyclerView}. This can be because it has
         ...
         * <p>
         * Note that when all animations are created by {@link MasterRecyclerView.ItemAnimator}, you
         ...
         * {@link #onViewDetachedFromWindow(MasterRecyclerView.ViewHolder) onViewDetachedFromWindow}
         ...
         * {@link MasterRecyclerView.AdapterDataObserver#onChanged()
         * "something changed"} event if more specific data is not available.</p>
         *
         * <p>Components registering observers with an adapter are responsible for
         * {@link #unregisterAdapterDataObserver(MasterRecyclerView.AdapterDataObserver)
         * unregistering} those observers when finished.</p>
         *
         * @param observer Observer to register
         *
         * @see #unregisterAdapterDataObserver(MasterRecyclerView.AdapterDataObserver)
         */
         ...
         *
         * @see #registerAdapterDataObserver(MasterRecyclerView.AdapterDataObserver)
         */
         ...
         *
         * @param masterRecyclerView The RecyclerView instance which started observing this adapter.
         * @see #onDetachedFromRecyclerView(MasterRecyclerView)
         */
         ...
         *
         * @param masterRecyclerView The RecyclerView instance which stopped observing this adapter.
         * @see #onAttachedToRecyclerView(MasterRecyclerView)
         */
    ...
    public static abstract class LayoutManager {
        ChildHelper mChildHelper;
        MasterRecyclerView mMasterRecyclerView;
        ...
        void setRecyclerView(MasterRecyclerView masterRecyclerView) {
            if (masterRecyclerView == null) {
                mMasterRecyclerView = null;
                mChildHelper = null;
                mWidth = 0;
                mHeight = 0;
            } else {
                mMasterRecyclerView = masterRecyclerView;
                mChildHelper = masterRecyclerView.mChildHelper;
                mWidth = masterRecyclerView.getWidth();
                mHeight = masterRecyclerView.getHeight();
            }
        ...
        void setMeasuredDimensionFromChildren(int widthSpec, int heightSpec) {
            final int count = getChildCount();
            if (count == 0) {
                mMasterRecyclerView.defaultOnMeasure(widthSpec, heightSpec);
                return;
            }
            ...
            for (int i = 0; i < count; i++) {
                ...
                final Rect bounds = mMasterRecyclerView.mTempRect;
            ...
            mMasterRecyclerView.mTempRect.set(minX, minY, maxX, maxY);
            setMeasuredDimension(mMasterRecyclerView.mTempRect, widthSpec, heightSpec);
        }

        /**
         * Sets the measured dimensions from the given bounding box of the children and the
         * measurement specs that were passed into {@link MasterRecyclerView#onMeasure(int, int)}. It is
         ...
         */
        public void requestLayout() {
            if(mMasterRecyclerView != null) {
                mMasterRecyclerView.requestLayout();
            }
        }
        ...
        public void assertInLayoutOrScroll(String message) {
            if (mMasterRecyclerView != null) {
                mMasterRecyclerView.assertInLayoutOrScroll(message);
            }
        }
        ...
        public void assertNotInLayoutOrScroll(String message) {
            if (mMasterRecyclerView != null) {
                mMasterRecyclerView.assertNotInLayoutOrScroll(message);
            }
        }
         ...
         * {@link MasterRecyclerView#onMeasure(int, int)} call, then calculating desired dimensions based
         ...
         * <li>When {@link MasterRecyclerView#onMeasure(int, int)} is called, if the provided specs are
         ...
         * {@link MasterRecyclerView#setItemAnimator(ItemAnimator) ItemAnimator} set on the
        ...
        void dispatchAttachedToWindow(MasterRecyclerView view) {
            mIsAttachedToWindow = true;
            onAttachedToWindow(view);
        }

        void dispatchDetachedFromWindow(MasterRecyclerView view, Recycler recycler) {
        ...
        public void postOnAnimation(Runnable action) {
            if (mMasterRecyclerView != null) {
                ViewCompat.postOnAnimation(mMasterRecyclerView, action);
            }
        }
        ...
        public boolean removeCallbacks(Runnable action) {
            if (mMasterRecyclerView != null) {
                return mMasterRecyclerView.removeCallbacks(action);
            }
            return false;
        }
        /**
         ...
         *
         * @see #onDetachedFromWindow(MasterRecyclerView, Recycler)
         */
        @CallSuper
        public void onAttachedToWindow(MasterRecyclerView view) {
        }

        /**
         * @deprecated
         * override {@link #onDetachedFromWindow(MasterRecyclerView, Recycler)}
         */
        @Deprecated
        public void onDetachedFromWindow(MasterRecyclerView view) {
         ...
         * call {@link MasterRecyclerView#requestLayout()} to ensure that it is re-laid out when
         ...
         *                 keeping them around.
         *
         * @see #onAttachedToWindow(MasterRecyclerView)
         */
        @CallSuper
        public void onDetachedFromWindow(MasterRecyclerView view, Recycler recycler) {
        ...
        public boolean getClipToPadding() {
            return mMasterRecyclerView != null && mMasterRecyclerView.mClipToPadding;
        }
         ...
         * {@link MasterRecyclerView.LayoutParams} for this purpose.</p>
         *
         ...
         * </p>
         * @param masterRecyclerView The RecyclerView to which this layout manager is attached
         * @param state    Current State of RecyclerView
         * @param position Scroll to this adapter position.
         */
        public void smoothScrollToPosition(MasterRecyclerView masterRecyclerView, State state,
                                           int position) {
        ...
        public void startSmoothScroll(SmoothScroller smoothScroller) {
            ...
            mSmoothScroller.start(mMasterRecyclerView, this);
        }
        ...
        public int getLayoutDirection() {
            return ViewCompat.getLayoutDirection(mMasterRecyclerView);
        }
         ...
         * @see MasterRecyclerView.ItemAnimator#endAnimations()
         */
        public void endAnimation(View view) {
            if (mMasterRecyclerView.mItemAnimator != null) {
                mMasterRecyclerView.mItemAnimator.endAnimation(getChildViewHolderInt(view));
            }
        }
        ...
        private void addViewInt(View child, int index, boolean disappearing) {
            ...
            if (disappearing || holder.isRemoved()) {
                ...
                mMasterRecyclerView.mViewInfoStore.addToDisappearedInLayout(holder);
            } else {
                ...
                mMasterRecyclerView.mViewInfoStore.removeFromDisappearedInLayout(holder);
            }
            final LayoutParams lp = (LayoutParams) child.getLayoutParams();
            if (holder.wasReturnedFromScrap() || holder.isScrap()) {
            ...
            } else if (child.getParent() == mMasterRecyclerView) { // it was not a scrap but a valid child
                ...
                if (currentIndex == -1) {
                    throw new IllegalStateException("Added View has RecyclerView as parent but"
                            ...
                            + mMasterRecyclerView.indexOfChild(child));
                }
                if (currentIndex != index) {
                    mMasterRecyclerView.mLayout.moveView(currentIndex, index);
                }
            } else {
        ...
        public int getPosition(View view) {
            return ((MasterRecyclerView.LayoutParams) view.getLayoutParams()).getViewLayoutPosition();
        }
         ...
         *
         * @see MasterRecyclerView#getChildViewHolder(View)
         * @see MasterRecyclerView#findContainingViewHolder(View)
         */
        @Nullable
        public View findContainingItemView(View view) {
            if (mMasterRecyclerView == null) {
            ...
            View found = mMasterRecyclerView.findContainingItemView(view);
            if (found == null) {
                return null;
            }
        ...
        public View findViewByPosition(int position) {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                if (vh.getLayoutPosition() == position && !vh.shouldIgnore() &&
                        (mMasterRecyclerView.mState.isPreLayout() || !vh.isRemoved())) {
                    return child;
                }
            }
            return null;
         ...
         * will want to use {@link #detachAndScrapView(android.view.View, MasterRecyclerView.Recycler)}
         ...
         * {@link #attachView(android.view.View, int, MasterRecyclerView.LayoutParams) reattach}
         ...
         * {@link #detachAndScrapView(android.view.View, MasterRecyclerView.Recycler)}  scrapped}.
         *
        ...
        public void attachView(View child, int index, LayoutParams lp) {
            ViewHolder vh = getChildViewHolderInt(child);
            if (vh.isRemoved()) {
                mMasterRecyclerView.mViewInfoStore.addToDisappearedInLayout(vh);
            } else {
                mMasterRecyclerView.mViewInfoStore.removeFromDisappearedInLayout(vh);
            }
        ...
        public void removeDetachedView(View child) {
            mMasterRecyclerView.removeDetachedView(child, false);
        }
        ...
        public int getPaddingLeft() {
            return mMasterRecyclerView != null ? mMasterRecyclerView.getPaddingLeft() : 0;
        }
        ...
        public int getPaddingTop() {
            return mMasterRecyclerView != null ? mMasterRecyclerView.getPaddingTop() : 0;
        }
        ...
        public int getPaddingRight() {
            return mMasterRecyclerView != null ? mMasterRecyclerView.getPaddingRight() : 0;
        }
        ...
        public int getPaddingBottom() {
            return mMasterRecyclerView != null ? mMasterRecyclerView.getPaddingBottom() : 0;
        }
        ...
        public int getPaddingStart() {
            return mMasterRecyclerView != null ? ViewCompat.getPaddingStart(mMasterRecyclerView) : 0;
        }
        ...
        public int getPaddingEnd() {
            return mMasterRecyclerView != null ? ViewCompat.getPaddingEnd(mMasterRecyclerView) : 0;
        }
        ...
        public boolean isFocused() {
            return mMasterRecyclerView != null && mMasterRecyclerView.isFocused();
        }
        ...
        public boolean hasFocus() {
            return mMasterRecyclerView != null && mMasterRecyclerView.hasFocus();
        }
        ...
        public View getFocusedChild() {
            ...
            final View focused = mMasterRecyclerView.getFocusedChild();
        ...
        public int getItemCount() {
            final Adapter a = mMasterRecyclerView != null ? mMasterRecyclerView.getAdapter() : null;
        ...
        public void offsetChildrenHorizontal(int dx) {
            if (mMasterRecyclerView != null) {
                mMasterRecyclerView.offsetChildrenHorizontal(dx);
            }
        }
        ...
        public void offsetChildrenVertical(int dy) {
            if (mMasterRecyclerView != null) {
                mMasterRecyclerView.offsetChildrenVertical(dy);
            }
        }
        ...
        public void ignoreView(View view) {
            if (view.getParent() != mMasterRecyclerView || mMasterRecyclerView.indexOfChild(view) == -1) {
            ...
            mMasterRecyclerView.mViewInfoStore.removeViewHolder(vh);
        }
        ...
        private void scrapOrRecycleView(Recycler recycler, int index, View view) {
            ...
            if (viewHolder.isInvalid() && !viewHolder.isRemoved() &&
                    !mMasterRecyclerView.mAdapter.hasStableIds()) {
                removeViewAt(index);
                recycler.recycleViewHolderInternal(viewHolder);
            } else {
                detachViewAt(index);
                recycler.scrapView(view);
                mMasterRecyclerView.mViewInfoStore.onViewDetached(viewHolder);
            }
        }
        ...
        void removeAndRecycleScrapInt(Recycler recycler) {
            ...
            for (int i = scrapCount - 1; i >= 0; i--) {
                ...
                if (vh.isTmpDetached()) {
                    mMasterRecyclerView.removeDetachedView(scrap, false);
                }
                if (mMasterRecyclerView.mItemAnimator != null) {
                    mMasterRecyclerView.mItemAnimator.endAnimation(vh);
                }
            ...
            recycler.clearScrap();
            if (scrapCount > 0) {
                mMasterRecyclerView.invalidate();
            }
        }
        ...
        public void measureChild(View child, int widthUsed, int heightUsed) {
            ...
            final Rect insets = mMasterRecyclerView.getItemDecorInsetsForChild(child);
        ...
        public void getTransformedBoundingBox(View child, boolean includeDecorInsets, Rect out) {
            ...
            if (mMasterRecyclerView != null) {
                ...
                if (childMatrix != null && !childMatrix.isIdentity()) {
                    final RectF tempRectF = mMasterRecyclerView.mTempRectF;
                    tempRectF.set(out);
        ...
        public void calculateItemDecorationsForChild(View child, Rect outRect) {
            ...
            Rect insets = mMasterRecyclerView.getItemDecorInsetsForChild(child);
            outRect.set(insets);
        }
         ...
         * then {@link #onFocusSearchFailed(View, int, MasterRecyclerView.Recycler, MasterRecyclerView.State)}
         ...
         */
        public boolean requestChildRectangleOnScreen(MasterRecyclerView parent, View child, Rect rect,
                                                     boolean immediate) {
        ...
        /**
         * @deprecated Use {@link #onRequestChildFocus(MasterRecyclerView, State, View, View)}
         */
        @Deprecated
        public boolean onRequestChildFocus(MasterRecyclerView parent, View child, View focused) {
         ...
         */
        public boolean onRequestChildFocus(MasterRecyclerView parent, State state, View child,
                                           View focused) {
         ...
         *                   {@link #setAdapter(MasterRecyclerView.Adapter)} is called with {@code null}.
         */
         ...
         *
         * @param masterRecyclerView The RecyclerView hosting this LayoutManager
         ...
         */
        public boolean onAddFocusables(MasterRecyclerView masterRecyclerView, ArrayList<View> views,
         ...
         *
         * @param masterRecyclerView
         */
        public void onItemsChanged(MasterRecyclerView masterRecyclerView) {
        }
         ...
         * @param itemCount
         */
        public void onItemsAdded(MasterRecyclerView masterRecyclerView, int positionStart, int itemCount) {
        }
         ...
         * @param itemCount
         */
        public void onItemsRemoved(MasterRecyclerView masterRecyclerView, int positionStart, int itemCount) {
        }

        /**
         * Called when items have been changed in the adapter.
         * To receive payload,  override {@link #onItemsUpdated(MasterRecyclerView, int, int, Object)}
         ...
         * @param itemCount
         */
        public void onItemsUpdated(MasterRecyclerView masterRecyclerView, int positionStart, int itemCount) {
        }

        /**
         * Called when items have been changed in the adapter and with optional payload.
         * Default implementation calls {@link #onItemsUpdated(MasterRecyclerView, int, int)}.
         *
         * @param masterRecyclerView
         * @param positionStart
         * @param itemCount
        ...
        public void onItemsUpdated(MasterRecyclerView masterRecyclerView, int positionStart, int itemCount,
                                   Object payload) {
            onItemsUpdated(masterRecyclerView, positionStart, itemCount);
        }
         ...
         * @param itemCount
         */
        public void onItemsMoved(MasterRecyclerView masterRecyclerView, int from, int to, int itemCount) {
         ...
         *
         * <p>Read {@link MasterRecyclerView#computeHorizontalScrollExtent()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current state of RecyclerView
         * @return The horizontal extent of the scrollbar's thumb
         * @see MasterRecyclerView#computeHorizontalScrollExtent()
         */
         ...
         * <p>Override this method if you want to support scroll bars.</p>
         *
         * <p>Read {@link MasterRecyclerView#computeHorizontalScrollOffset()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current State of RecyclerView where you can find total item count
         * @return The horizontal offset of the scrollbar's thumb
         * @see MasterRecyclerView#computeHorizontalScrollOffset()
         */
         ...
         * <p>Override this method if you want to support scroll bars.</p>
         *
         * <p>Read {@link MasterRecyclerView#computeHorizontalScrollRange()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current State of RecyclerView where you can find total item count
         * @return The total horizontal range represented by the vertical scrollbar
         * @see MasterRecyclerView#computeHorizontalScrollRange()
         */
         ...
         * <p>Override this method if you want to support scroll bars.</p>
         *
         * <p>Read {@link MasterRecyclerView#computeVerticalScrollExtent()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current state of RecyclerView
         * @return The vertical extent of the scrollbar's thumb
         * @see MasterRecyclerView#computeVerticalScrollExtent()
         */
         ...
         * <p>Override this method if you want to support scroll bars.</p>
         *
         * <p>Read {@link MasterRecyclerView#computeVerticalScrollOffset()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current State of RecyclerView where you can find total item count
         * @return The vertical offset of the scrollbar's thumb
         * @see MasterRecyclerView#computeVerticalScrollOffset()
         */
         ...
         * <p>Override this method if you want to support scroll bars.</p>
         *
         * <p>Read {@link MasterRecyclerView#computeVerticalScrollRange()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current State of RecyclerView where you can find total item count
         * @return The total vertical range represented by the vertical scrollbar
         * @see MasterRecyclerView#computeVerticalScrollRange()
         */
        ...
        public void setMeasuredDimension(int widthSize, int heightSize) {
            mMasterRecyclerView.setMeasuredDimension(widthSize, heightSize);
        }
        ...
        public int getMinimumWidth() {
            return ViewCompat.getMinimumWidth(mMasterRecyclerView);
        }
        ...
        public int getMinimumHeight() {
            return ViewCompat.getMinimumHeight(mMasterRecyclerView);
        }
        /**
        ...
        void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfoCompat info) {
            onInitializeAccessibilityNodeInfo(mMasterRecyclerView.mRecycler, mMasterRecyclerView.mState, info);
        }
         ...
         * <p>
         * You should override
         * {@link #getRowCountForAccessibility(MasterRecyclerView.Recycler, MasterRecyclerView.State)},
         * {@link #getColumnCountForAccessibility(MasterRecyclerView.Recycler, MasterRecyclerView.State)},
         * {@link #isLayoutHierarchical(MasterRecyclerView.Recycler, MasterRecyclerView.State)} and
         * {@link #getSelectionModeForAccessibility(MasterRecyclerView.Recycler, MasterRecyclerView.State)} for
         ...
         * @see #getRowCountForAccessibility(MasterRecyclerView.Recycler, MasterRecyclerView.State)
         * @see #getColumnCountForAccessibility(MasterRecyclerView.Recycler, MasterRecyclerView.State)
         * @see #isLayoutHierarchical(MasterRecyclerView.Recycler, MasterRecyclerView.State)
         * @see #getSelectionModeForAccessibility(MasterRecyclerView.Recycler, MasterRecyclerView.State)
         */
        public void onInitializeAccessibilityNodeInfo(Recycler recycler, State state,
                AccessibilityNodeInfoCompat info) {
            if (ViewCompat.canScrollVertically(mMasterRecyclerView, -1) ||
                    ViewCompat.canScrollHorizontally(mMasterRecyclerView, -1)) {
        ...
        public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
            onInitializeAccessibilityEvent(mMasterRecyclerView.mRecycler, mMasterRecyclerView.mState, event);
        }
        ...
        public void onInitializeAccessibilityEvent(Recycler recycler, State state,
            ...
            final AccessibilityRecordCompat record = AccessibilityEventCompat
                    .asRecord(event);
            if (mMasterRecyclerView == null || record == null) {
                return;
            }
            record.setScrollable(ViewCompat.canScrollVertically(mMasterRecyclerView, 1)
                    || ViewCompat.canScrollVertically(mMasterRecyclerView, -1)
                    || ViewCompat.canScrollHorizontally(mMasterRecyclerView, -1)
                    || ViewCompat.canScrollHorizontally(mMasterRecyclerView, 1));

            if (mMasterRecyclerView.mAdapter != null) {
                record.setItemCount(mMasterRecyclerView.mAdapter.getItemCount());
            }
        }
        ...
        void onInitializeAccessibilityNodeInfoForItem(View host, AccessibilityNodeInfoCompat info) {
            ...
            if (vh != null && !vh.isRemoved() && !mChildHelper.isHidden(vh.itemView)) {
                onInitializeAccessibilityNodeInfoForItem(mMasterRecyclerView.mRecycler,
                        mMasterRecyclerView.mState, host, info);
            }
        }
        ...
        public int getRowCountForAccessibility(Recycler recycler, State state) {
            if (mMasterRecyclerView == null || mMasterRecyclerView.mAdapter == null) {
                return 1;
            }
            return canScrollVertically() ? mMasterRecyclerView.mAdapter.getItemCount() : 1;
        }
        ...
        public int getColumnCountForAccessibility(Recycler recycler, State state) {
            ...
            return canScrollHorizontally() ? mMasterRecyclerView.mAdapter.getItemCount() : 1;
        }
        ...
        boolean performAccessibilityAction(int action, Bundle args) {
            return performAccessibilityAction(mMasterRecyclerView.mRecycler, mMasterRecyclerView.mState,
                    action, args);
        }
        ...
        public boolean performAccessibilityAction(Recycler recycler, State state, int action,
            ...
            switch (action) {
                case AccessibilityNodeInfoCompat.ACTION_SCROLL_BACKWARD:
                    ...
                    if (ViewCompat.canScrollHorizontally(mMasterRecyclerView, -1)) {
            ...
            mMasterRecyclerView.scrollBy(hScroll, vScroll);
            return true;
        }

        // called by accessibility delegate
        boolean performAccessibilityActionForItem(View view, int action, Bundle args) {
            return performAccessibilityActionForItem(mMasterRecyclerView.mRecycler, mMasterRecyclerView.mState,
                    view, action, args);
        }
        ...
        public static Properties getProperties(Context context, AttributeSet attrs,
            ...
            properties.orientation = a.getInt(R.styleable.MasterRecyclerView_android_orientation, VERTICAL);
            properties.spanCount = a.getInt(R.styleable.MasterRecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(R.styleable.MasterRecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(R.styleable.MasterRecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }

        void setExactMeasureSpecsFrom(MasterRecyclerView masterRecyclerView) {
            setMeasureSpecs(
                    MeasureSpec.makeMeasureSpec(masterRecyclerView.getWidth(), MeasureSpec.EXACTLY),
                    MeasureSpec.makeMeasureSpec(masterRecyclerView.getHeight(), MeasureSpec.EXACTLY)
            );
        }
     ...
     * views (in {@link ItemDecoration#onDraw(Canvas, MasterRecyclerView, MasterRecyclerView.State) onDraw()}
     * and after the items (in {@link ItemDecoration#onDrawOver(Canvas, MasterRecyclerView,
     * MasterRecyclerView.State)}.</p>
     */
    public static abstract class ItemDecoration {
         ...
         * @param state The current state of RecyclerView
         */
        public void onDraw(Canvas c, MasterRecyclerView parent, State state) {
            onDraw(c, parent);
        }

        /**
         * @deprecated
         * Override {@link #onDraw(Canvas, MasterRecyclerView, MasterRecyclerView.State)}
         */
        @Deprecated
        public void onDraw(Canvas c, MasterRecyclerView parent) {
        }
         ...
         * @param state The current state of RecyclerView.
         */
        public void onDrawOver(Canvas c, MasterRecyclerView parent, State state) {
            onDrawOver(c, parent);
        }

        /**
         * @deprecated
         * Override {@link #onDrawOver(Canvas, MasterRecyclerView, MasterRecyclerView.State)}
         */
        @Deprecated
        public void onDrawOver(Canvas c, MasterRecyclerView parent) {
        }


        /**
         * @deprecated
         * Use {@link #getItemOffsets(Rect, View, MasterRecyclerView, State)}
         */
        @Deprecated
        public void getItemOffsets(Rect outRect, int itemPosition, MasterRecyclerView parent) {
            outRect.set(0, 0, 0, 0);
        }
         ...
         * {@link MasterRecyclerView#getChildAdapterPosition(View)} to get the adapter position of the
         * View.
         *
         ...
         * @param state   The current state of RecyclerView.
         */
        public void getItemOffsets(Rect outRect, View view, MasterRecyclerView parent, State state) {
    ...
    /**
     * An implementation of {@link MasterRecyclerView.OnItemTouchListener} that has empty method bodies and
     ...
     */
    public static class SimpleOnItemTouchListener implements MasterRecyclerView.OnItemTouchListener {
        @Override
        public boolean onInterceptTouchEvent(MasterRecyclerView rv, MotionEvent e) {
            return false;
        }
     ...
     * <p>
     * @see MasterRecyclerView#addOnScrollListener(OnScrollListener)
     * @see MasterRecyclerView#clearOnChildAttachStateChangeListeners()
     *
     */
    public abstract static class OnScrollListener {
         ...
         *
         * @param masterRecyclerView The RecyclerView whose scroll state has changed.
         * @param newState     The updated scroll state. One of {@link #SCROLL_STATE_IDLE},
         *                     {@link #SCROLL_STATE_DRAGGING} or {@link #SCROLL_STATE_SETTLING}.
         */
        public void onScrollStateChanged(MasterRecyclerView masterRecyclerView, int newState){}
         ...
         *
         * @param masterRecyclerView The RecyclerView which scrolled.
         * @param dx The amount of horizontal scroll.
         * @param dy The amount of vertical scroll.
         */
        public void onScrolled(MasterRecyclerView masterRecyclerView, int dx, int dy){}
    }
     ...
     * a view is recycled.
     *
     * @see MasterRecyclerView#setRecyclerListener(RecyclerListener)
     */
    ...
    public static abstract class ViewHolder {
         ...
         * {@link RecycledViewPool}.
         */
        MasterRecyclerView mOwnerMasterRecyclerView;
         ...
         * positions. All methods in {@link MasterRecyclerView.LayoutManager}, {@link MasterRecyclerView.State},
         * {@link MasterRecyclerView.Recycler} that receive a position expect it to be the layout position
         * of the item.
         * <p>
         * If LayoutManager needs to call an external method that requires the adapter position of
         * the item, it can use {@link #getAdapterPosition()} or
         * {@link MasterRecyclerView.Recycler#convertPreLayoutPositionToPostLayout(int)}.
         *
         ...
         * <p>
         * Note that if you've called {@link MasterRecyclerView.Adapter#notifyDataSetChanged()}, until the
         * next layout pass, the return value of this method will be {@link #NO_POSITION}.
         *
         * @return The adapter position of the item if it still exists in the adapter.
         * {@link MasterRecyclerView#NO_POSITION} if item has been removed from the adapter,
         * {@link MasterRecyclerView.Adapter#notifyDataSetChanged()} has been called after the last
         * layout pass or the ViewHolder has already been recycled.
         */
        public final int getAdapterPosition() {
            if (mOwnerMasterRecyclerView == null) {
                return NO_POSITION;
            }
            return mOwnerMasterRecyclerView.getAdapterPositionFor(this);
        }
         ...
         *
         * @return The the item's id if adapter has stable ids, {@link MasterRecyclerView#NO_ID}
         * otherwise
         */
    ...
    private int getAdapterPositionFor(ViewHolder viewHolder) {
        if (viewHolder.hasAnyOfTheFlags( ViewHolder.FLAG_INVALID |
                ...
                || !viewHolder.isBound()) {
            return MasterRecyclerView.NO_POSITION;
        }
     ...
     * {@link MasterRecyclerView}. Custom {@link LayoutManager layout managers} are encouraged
    ...
    public static class LayoutParams extends android.view.ViewGroup.MarginLayoutParams {
         ...
         * {@link MasterRecyclerView#NO_POSITION} if item represented by this View has been removed or
    ...
    public static abstract class SmoothScroller {
        ...
        private int mTargetPosition = MasterRecyclerView.NO_POSITION;

        private MasterRecyclerView mMasterRecyclerView;
         ...
         * <p>In each animation step, {@link MasterRecyclerView} will check
         * for the target view and call either
         * {@link #onTargetFound(android.view.View, MasterRecyclerView.State, SmoothScroller.Action)} or
         * {@link #onSeekTargetStep(int, int, MasterRecyclerView.State, SmoothScroller.Action)} until
         ...
         */
        void start(MasterRecyclerView masterRecyclerView, LayoutManager layoutManager) {
            mMasterRecyclerView = masterRecyclerView;
            mLayoutManager = layoutManager;
            if (mTargetPosition == MasterRecyclerView.NO_POSITION) {
                throw new IllegalArgumentException("Invalid target position");
            }
            mMasterRecyclerView.mState.mTargetPosition = mTargetPosition;
            mRunning = true;
            mPendingInitialRun = true;
            mTargetView = findViewByPosition(getTargetPosition());
            onStart();
            mMasterRecyclerView.mViewFlinger.postOnAnimation();
        }
         ...
         * {@link #onTargetFound(android.view.View, MasterRecyclerView.State, SmoothScroller.Action)} or
         * {@link #onSeekTargetStep(int, int, MasterRecyclerView.State, SmoothScroller.Action)}.
         */
        final protected void stop() {
            ...
            onStop();
            mMasterRecyclerView.mState.mTargetPosition = MasterRecyclerView.NO_POSITION;
            mTargetView = null;
            mTargetPosition = MasterRecyclerView.NO_POSITION;
         ...
         * {@link MasterRecyclerView#NO_POSITION} if no target view is set.
         */
        ...
        private void onAnimation(int dx, int dy) {
            final MasterRecyclerView masterRecyclerView = mMasterRecyclerView;
            if (!mRunning || mTargetPosition == MasterRecyclerView.NO_POSITION || masterRecyclerView == null) {
                stop();
            }
            mPendingInitialRun = false;
            if (mTargetView != null) {
                ...
                if (getChildPosition(mTargetView) == mTargetPosition) {
                    onTargetFound(mTargetView, masterRecyclerView.mState, mRecyclingAction);
                    mRecyclingAction.runIfNecessary(masterRecyclerView);
                    stop();
                } else {
            ...
            if (mRunning) {
                onSeekTargetStep(dx, dy, masterRecyclerView.mState, mRecyclingAction);
                ...
                if (hadJumpTarget) {
                    ...
                    if (mRunning) {
                        mPendingInitialRun = true;
                        masterRecyclerView.mViewFlinger.postOnAnimation();
                    } else {
                        stop(); // done
                    }
                }
        ...
        /**
         * @see MasterRecyclerView#getChildLayoutPosition(android.view.View)
         */
        public int getChildPosition(View view) {
            return mMasterRecyclerView.getChildLayoutPosition(view);
        }

        /**
         * @see MasterRecyclerView.LayoutManager#getChildCount()
         */
        public int getChildCount() {
            return mMasterRecyclerView.mLayout.getChildCount();
        }

        /**
         * @see MasterRecyclerView.LayoutManager#findViewByPosition(int)
         */
        public View findViewByPosition(int position) {
            return mMasterRecyclerView.mLayout.findViewByPosition(position);
        }

        /**
         * @see MasterRecyclerView#scrollToPosition(int)
         * @deprecated Use {@link Action#jumpTo(int)}.
         */
        @Deprecated
        public void instantScrollToPosition(int position) {
            mMasterRecyclerView.scrollToPosition(position);
        }
        ...
        public static class Action {
             ...
             * {@link MasterRecyclerView#scrollToPosition(int)}.
             * <p>
            ...
            private void runIfNecessary(MasterRecyclerView masterRecyclerView) {
                if (mJumpToPosition >= 0) {
                    final int position = mJumpToPosition;
                    mJumpToPosition = NO_POSITION;
                    masterRecyclerView.jumpToPositionForSmoothScroller(position);
                    changed = false;
                    return;
                }
                if (changed) {
                    ...
                    if (mInterpolator == null) {
                        if (mDuration == UNDEFINED_DURATION) {
                            masterRecyclerView.mViewFlinger.smoothScrollBy(mDx, mDy);
                        } else {
                            masterRecyclerView.mViewFlinger.smoothScrollBy(mDx, mDy, mDuration);
                        }
                    } else {
                        masterRecyclerView.mViewFlinger.smoothScrollBy(mDx, mDy, mDuration, mInterpolator);
                    }
                    consecutiveUpdates ++;
    ...
    public static class State {
         ...
         * {@link MasterRecyclerView#NO_POSITION} if there is no target
         * position.
         */
        ...
        public boolean hasTargetScrollPosition() {
            return mTargetPosition != MasterRecyclerView.NO_POSITION;
        }
    ...
    public static abstract class ItemAnimator {
         ...
         *                 {@link MasterRecyclerView.Adapter#notifyDataSetChanged()}. The same list of
         *                 payloads will be passed into
         *                 {@link MasterRecyclerView.Adapter#onBindViewHolder(ViewHolder, int, List)}
         ...
         * {@link #recordPreLayoutInformation(MasterRecyclerView.State, ViewHolder, int, List)} and
         * {@link #recordPostLayoutInformation(MasterRecyclerView.State, ViewHolder)} returns this data
        ...
        public static class ItemHolderInfo {
            ...
            /**
             * The change flags that were passed to
             * {@link #recordPreLayoutInformation(MasterRecyclerView.State, ViewHolder, int, List)}.
             */
            @AdapterChanges
             ...
             */
            public ItemHolderInfo setFrom(MasterRecyclerView.ViewHolder holder) {
             ...
             *               {@link #recordPreLayoutInformation(MasterRecyclerView.State, ViewHolder, int,
             *               List)}.
             * @return This {@link ItemHolderInfo}
             */
            public ItemHolderInfo setFrom(MasterRecyclerView.ViewHolder holder,
    ...
    public interface ChildDrawingOrderCallback {
         ...
         *
         * @see MasterRecyclerView#setChildDrawingOrderCallback(MasterRecyclerView.ChildDrawingOrderCallback)
         */
