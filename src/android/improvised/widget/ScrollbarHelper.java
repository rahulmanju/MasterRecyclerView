...
class ScrollbarHelper {
     ...
     */
    static int computeScrollOffset(MasterRecyclerView.State state, OrientationHelper orientation,
                                   View startChild, View endChild, MasterRecyclerView.LayoutManager lm,
     ...
     * @param endChild   View closest to end of the list (bottom or right)
     */
    static int computeScrollExtent(MasterRecyclerView.State state, OrientationHelper orientation,
                                   View startChild, View endChild, MasterRecyclerView.LayoutManager lm,
     ...
     * @param endChild   View closest to end of the list (bottom or right)
     */
    static int computeScrollRange(MasterRecyclerView.State state, OrientationHelper orientation,
                                  View startChild, View endChild, MasterRecyclerView.LayoutManager lm,
                                  boolean smoothScrollbarEnabled) {
        if (lm.getChildCount() == 0 || state.getItemCount() == 0 || startChild == null ||
                endChild == null) {
