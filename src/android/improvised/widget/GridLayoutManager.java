...
/**
 * A {@link MasterRecyclerView.LayoutManager} implementations that lays out items in a grid.
 * <p>
...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    private void ensureAnchorIsInCorrectSpan(MasterRecyclerView.Recycler recycler,
                                             MasterRecyclerView.State state, AnchorInfo anchorInfo, int itemDirection) {
    ...
    private int getSpanGroupIndex(MasterRecyclerView.Recycler recycler, MasterRecyclerView.State state,
                                  int viewPosition) {
        if (!state.isPreLayout()) {
    ...
    private int getSpanIndex(MasterRecyclerView.Recycler recycler, MasterRecyclerView.State state, int pos) {
        if (!state.isPreLayout()) {
    ...
    private int getSpanSize(MasterRecyclerView.Recycler recycler, MasterRecyclerView.State state, int pos) {
        if (!state.isPreLayout()) {
    ...
    private void assignSpans(MasterRecyclerView.Recycler recycler, MasterRecyclerView.State state, int count,
