 ...
 */
public class AttachDetachCollector implements MasterRecyclerView.OnChildAttachStateChangeListener {
    private final List<View> mAttached = new ArrayList<>();
    private final List<View> mDetached = new ArrayList<>();

    public AttachDetachCollector(MasterRecyclerView masterRecyclerView) {
        masterRecyclerView.addOnChildAttachStateChangeListener(this);
    }
