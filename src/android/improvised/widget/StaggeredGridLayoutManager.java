 ...
 */
public class StaggeredGridLayoutManager extends MasterRecyclerView.LayoutManager {
    ...
    /**
     * When scroll state is changed to {@link MasterRecyclerView#SCROLL_STATE_IDLE}, StaggeredGrid will
    ...
    public void onScrollStateChanged(int state) {
        if (state == MasterRecyclerView.SCROLL_STATE_IDLE) {
            checkForGaps();
        }
    }
     ...
     * When set to true, If {@link MasterRecyclerView} is LTR, than it will layout from RTL, if
     * {@link MasterRecyclerView}} is RTL, it will layout from LTR.
     *
    ...
    private void onLayoutChildren(MasterRecyclerView.Recycler recycler, MasterRecyclerView.State state,
        ...
        if (!anchorInfo.mValid || mPendingScrollPosition != MasterRecyclerView.NO_POSITION ||
    ...
    private void applyPendingSavedState(AnchorInfo anchorInfo) {
        ...
        if (mPendingSavedState.mAnchorPosition != MasterRecyclerView.NO_POSITION) {
    ...
    void updateAnchorInfoForLayout(MasterRecyclerView.State state, AnchorInfo anchorInfo) {
    ...
    private boolean updateAnchorFromChildren(MasterRecyclerView.State state, AnchorInfo anchorInfo) {
    ...
    boolean updateAnchorFromPendingData(MasterRecyclerView.State state, AnchorInfo anchorInfo) {
        ...
        if (mPendingSavedState == null || mPendingSavedState.mAnchorPosition == MasterRecyclerView.NO_POSITION
                || mPendingSavedState.mSpanOffsetsSize < 1) {
     ...
     * any items, {@link MasterRecyclerView#NO_POSITION} is returned for that span.
     ...
     * not have any items, {@link MasterRecyclerView#NO_POSITION} is returned for that span.
     ...
     * have any items, {@link MasterRecyclerView#NO_POSITION} is returned for that span.
     * @see #findFirstCompletelyVisibleItemPositions(int[])
     * @see #findLastVisibleItemPositions(int[])
     */
    ...
    public Parcelable onSaveInstanceState() {
        ...
        if (getChildCount() > 0) {
            ...
            state.mAnchorPosition = MasterRecyclerView.NO_POSITION;
            state.mVisibleAnchorPosition = MasterRecyclerView.NO_POSITION;
    ...
    @Override
    public void onInitializeAccessibilityNodeInfoForItem(MasterRecyclerView.Recycler recycler,
                                                         MasterRecyclerView.State state, View host, AccessibilityNodeInfoCompat info) {
    ...
    int findFirstVisibleItemPositionInt() {
        ...
        return first == null ? MasterRecyclerView.NO_POSITION : getPosition(first);
    }

    @Override
    public int getRowCountForAccessibility(MasterRecyclerView.Recycler recycler,
    ...
    @Override
    public int getColumnCountForAccessibility(MasterRecyclerView.Recycler recycler,
                                              MasterRecyclerView.State state) {
        if (mOrientation == VERTICAL) {
            return mSpanCount;
        }
    ...
    private void fixEndGap(MasterRecyclerView.Recycler recycler, MasterRecyclerView.State state,
    ...
    private void fixStartGap(MasterRecyclerView.Recycler recycler, MasterRecyclerView.State state,
                             boolean canOffsetChildren) {
    ...
    private void updateLayoutState(int anchorPosition, MasterRecyclerView.State state) {
        ...
        if (isSmoothScrolling()) {
            ...
            if (targetPos != MasterRecyclerView.NO_POSITION) {
    ...
    private int fill(MasterRecyclerView.Recycler recycler, LayoutState layoutState,
                     MasterRecyclerView.State state) {
    ...
    private void recycle(MasterRecyclerView.Recycler recycler, LayoutState layoutState) {
    ...
    private void recycleFromStart(MasterRecyclerView.Recycler recycler, int line) {
    ...
    private void recycleFromEnd(MasterRecyclerView.Recycler recycler, int line) {
        final int childCount = getChildCount();
        int i;
    ...
    public void smoothScrollToPosition(MasterRecyclerView masterRecyclerView, MasterRecyclerView.State state,
                                       int position) {
        LinearSmoothScroller scroller = new LinearSmoothScroller(masterRecyclerView.getContext()) {
            @Override
    ...
    int scrollBy(int dt, MasterRecyclerView.Recycler recycler, MasterRecyclerView.State state) {
    ...
    @Override
    public MasterRecyclerView.LayoutParams generateLayoutParams(Context c, AttributeSet attrs) {
        return new LayoutParams(c, attrs);
    }

    @Override
    public MasterRecyclerView.LayoutParams generateLayoutParams(ViewGroup.LayoutParams lp) {
    ...
    @Override
    public boolean checkLayoutParams(MasterRecyclerView.LayoutParams lp) {
    ...
    @Nullable
    @Override
    public View onFocusSearchFailed(View focused, int direction, MasterRecyclerView.Recycler recycler,
                                    MasterRecyclerView.State state) {
        if (getChildCount() == 0) {
            return null;
        }
     ...
     */
    public static class LayoutParams extends MasterRecyclerView.LayoutParams {
        ...
        public LayoutParams(MasterRecyclerView.LayoutParams source) {
            super(source);
        }
    ...
    static class LazySpanLookup {
        ...
        int invalidateAfter(int position) {
            ...
            if (endPosition == MasterRecyclerView.NO_POSITION) {
    ...
    public static class SavedState implements Parcelable {
        ...
        void invalidateAnchorPositionInfo() {
            ...
            mVisibleAnchorPosition = MasterRecyclerView.NO_POSITION;
        }
