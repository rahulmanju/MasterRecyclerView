 ...
 * decorations.
 *
 * @see #createHorizontalHelper(MasterRecyclerView.LayoutManager)
 * @see #createVerticalHelper(MasterRecyclerView.LayoutManager)
 */
public abstract class OrientationHelper {

    private static final int INVALID_SIZE = Integer.MIN_VALUE;

    protected final MasterRecyclerView.LayoutManager mLayoutManager;
    ...
    private OrientationHelper(MasterRecyclerView.LayoutManager layoutManager) {
     ...
     * {@link MasterRecyclerView.LayoutManager#onLayoutChildren(MasterRecyclerView.Recycler,
     * MasterRecyclerView.State)} method.
     *
     ...
     * its position
     *
     * @see MasterRecyclerView.LayoutManager#getTransformedBoundingBox(View, boolean, Rect)
     */
     ...
     * @see MasterRecyclerView.LayoutManager#getWidthMode()
     * @see MasterRecyclerView.LayoutManager#getHeightMode()
     */
    ...
    public static OrientationHelper createOrientationHelper(
            MasterRecyclerView.LayoutManager layoutManager, int orientation) {
        switch (orientation) {
            case HORIZONTAL:
    ...
    public static OrientationHelper createHorizontalHelper(
            MasterRecyclerView.LayoutManager layoutManager) {
        return new OrientationHelper(layoutManager) {
            ...
            public int getDecoratedMeasurement(View view) {
                final MasterRecyclerView.LayoutParams params = (MasterRecyclerView.LayoutParams)
     ...
     * @return A new OrientationHelper
     */
    public static OrientationHelper createVerticalHelper(MasterRecyclerView.LayoutManager layoutManager) {
        return new OrientationHelper(layoutManager) {
            @Override
            public int getEndAfterPadding() {
