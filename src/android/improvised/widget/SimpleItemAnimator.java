 ...
 */
abstract public class SimpleItemAnimator extends MasterRecyclerView.ItemAnimator {
     ...
     * {@link #animateChange(MasterRecyclerView.ViewHolder, MasterRecyclerView.ViewHolder, int, int, int, int)} implementation.
     ...
     *                                 {@link #animateChange(MasterRecyclerView.ViewHolder, MasterRecyclerView.ViewHolder, int, int, int,
     *                                 int)} when changes occur.
     * @see MasterRecyclerView.Adapter#notifyItemChanged(int)
     * @see MasterRecyclerView.Adapter#notifyItemRangeChanged(int, int)
     */
     ...
     */
    @Override
    public boolean canReuseUpdatedViewHolder(@NonNull MasterRecyclerView.ViewHolder viewHolder) {
        return !mSupportsChangeAnimations || viewHolder.isInvalid();
    }

    @Override
    public boolean animateDisappearance(@NonNull MasterRecyclerView.ViewHolder viewHolder,
    ...
    @Override
    public boolean animateAppearance(@NonNull MasterRecyclerView.ViewHolder viewHolder,
    ...
    @Override
    public boolean animatePersistence(@NonNull MasterRecyclerView.ViewHolder viewHolder,
    ...
    @Override
    public boolean animateChange(@NonNull MasterRecyclerView.ViewHolder oldHolder, @NonNull MasterRecyclerView.ViewHolder newHolder,
                                 @NonNull ItemHolderInfo preInfo, @NonNull ItemHolderInfo postInfo) {
        if (DEBUG) {
     ...
     * {@link #dispatchRemoveFinished(MasterRecyclerView.ViewHolder)} when done, either
     * immediately (if no animation will occur) or after the animation actually finishes.
     * The return value indicates whether an animation has been set up and whether the
     * ItemAnimator's {@link #runPendingAnimations()} method should be called at the
     * next opportunity. This mechanism allows ItemAnimator to set up individual animations
     * as separate calls to {@link #animateAdd(MasterRecyclerView.ViewHolder) animateAdd()},
     * {@link #animateMove(MasterRecyclerView.ViewHolder, int, int, int, int) animateMove()},
     * {@link #animateRemove(MasterRecyclerView.ViewHolder) animateRemove()}, and
     * {@link #animateChange(MasterRecyclerView.ViewHolder, MasterRecyclerView.ViewHolder, int, int, int, int)} come in one by one,
     ...
     * false otherwise.
     */
    abstract public boolean animateRemove(MasterRecyclerView.ViewHolder holder);

    /**
     * Called when an item is added to the RecyclerView. Implementors can choose
     * whether and how to animate that change, but must always call
     * {@link #dispatchAddFinished(MasterRecyclerView.ViewHolder)} when done, either
     * immediately (if no animation will occur) or after the animation actually finishes.
     * The return value indicates whether an animation has been set up and whether the
     * ItemAnimator's {@link #runPendingAnimations()} method should be called at the
     * next opportunity. This mechanism allows ItemAnimator to set up individual animations
     ...
     * false otherwise.
     */
    abstract public boolean animateAdd(MasterRecyclerView.ViewHolder holder);

    /**
     * Called when an item is moved in the RecyclerView. Implementors can choose
     * whether and how to animate that change, but must always call
     * {@link #dispatchMoveFinished(MasterRecyclerView.ViewHolder)} when done, either
     * immediately (if no animation will occur) or after the animation actually finishes.
     * The return value indicates whether an animation has been set up and whether the
     * ItemAnimator's {@link #runPendingAnimations()} method should be called at the
     * next opportunity. This mechanism allows ItemAnimator to set up individual animations
     ...
     * false otherwise.
     */
    abstract public boolean animateMove(MasterRecyclerView.ViewHolder holder, int fromX, int fromY,
                                        int toX, int toY);

    /**
     * Called when an item is changed in the RecyclerView, as indicated by a call to
     * {@link MasterRecyclerView.Adapter#notifyItemChanged(int)} or
     * {@link MasterRecyclerView.Adapter#notifyItemRangeChanged(int, int)}.
     * <p>
     * Implementers can choose whether and how to animate changes, but must always call
     * {@link #dispatchChangeFinished(MasterRecyclerView.ViewHolder, boolean)} for each non-null distinct ViewHolder,
     ...
     * {@link #dispatchChangeFinished(MasterRecyclerView.ViewHolder, boolean)} once and only once. In that case, the
     ...
     * false otherwise.
     */
    abstract public boolean animateChange(MasterRecyclerView.ViewHolder oldHolder,
                                          MasterRecyclerView.ViewHolder newHolder, int fromLeft, int fromTop, int toLeft, int toTop);

    /**
     * Method to be called by subclasses when a remove animation is done.
     *
     * @param item The item which has been removed
     * @see MasterRecyclerView.ItemAnimator#animateDisappearance(MasterRecyclerView.ViewHolder, ItemHolderInfo,
     * ItemHolderInfo)
     */
    public final void dispatchRemoveFinished(MasterRecyclerView.ViewHolder item) {
     ...
     * @see MasterRecyclerView.ItemAnimator#animateDisappearance(MasterRecyclerView.ViewHolder, ItemHolderInfo,
     * ItemHolderInfo)
     * @see MasterRecyclerView.ItemAnimator#animatePersistence(MasterRecyclerView.ViewHolder, ItemHolderInfo, ItemHolderInfo)
     * @see MasterRecyclerView.ItemAnimator#animateAppearance(MasterRecyclerView.ViewHolder, ItemHolderInfo, ItemHolderInfo)
     */
    public final void dispatchMoveFinished(MasterRecyclerView.ViewHolder item) {
        onMoveFinished(item);
        dispatchAnimationFinished(item);
    }
     ...
     */
    public final void dispatchAddFinished(MasterRecyclerView.ViewHolder item) {
        onAddFinished(item);
        dispatchAnimationFinished(item);
    }
     ...
     *                {@link #animateChange(MasterRecyclerView.ViewHolder, MasterRecyclerView.ViewHolder, int, int, int, int)}).
     * @param oldItem true if this is the old item that was changed, false if
     *                it is the new item that replaced the old item.
     * @see #animateChange(MasterRecyclerView.ViewHolder, MasterRecyclerView.ViewHolder, int, int, int, int)
     */
    public final void dispatchChangeFinished(MasterRecyclerView.ViewHolder item, boolean oldItem) {
     ...
     */
    public final void dispatchRemoveStarting(MasterRecyclerView.ViewHolder item) {
     ...
     */
    public final void dispatchMoveStarting(MasterRecyclerView.ViewHolder item) {
        onMoveStarting(item);
    }
     ...
     */
    public final void dispatchAddStarting(MasterRecyclerView.ViewHolder item) {
        onAddStarting(item);
    }
     ...
     *                it is the new item that replaced the old item.
     */
    public final void dispatchChangeStarting(MasterRecyclerView.ViewHolder item, boolean oldItem) {
    ...
    public void onRemoveStarting(MasterRecyclerView.ViewHolder item) {
    }
     ...
     * @param item The ViewHolder being animated.
     */
    public void onRemoveFinished(MasterRecyclerView.ViewHolder item) {
    }
     ...
     */
    @SuppressWarnings("UnusedParameters")
    public void onAddStarting(MasterRecyclerView.ViewHolder item) {
    }
     ...
     * @param item The ViewHolder being animated.
     */
    public void onAddFinished(MasterRecyclerView.ViewHolder item) {
    }
     ...
     */
    @SuppressWarnings("UnusedParameters")
    public void onMoveStarting(MasterRecyclerView.ViewHolder item) {
    }
     ...
     * @param item The ViewHolder being animated.
     */
    public void onMoveFinished(MasterRecyclerView.ViewHolder item) {
    }
     ...
     */
    @SuppressWarnings("UnusedParameters")
    public void onChangeStarting(MasterRecyclerView.ViewHolder item, boolean oldItem) {
    }
     ...
     *                it is the new item that replaced the old item.
     */
    public void onChangeFinished(MasterRecyclerView.ViewHolder item, boolean oldItem) {
    }
}
